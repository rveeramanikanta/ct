/**
 * 
 */var onAfterChangeCallBackFun = function(flag) {
	...
	introjs.onafterchange(function(targetElement) {
		...
		case "btnsDiv":
			...
			/*introjs._introItems.splice(2, introjs._introItems.length - 2);*/
			$(".introjs-helperLayer").one("transitionend", function() {
				if (introjs._currentStep == 1) {
					/*doPlayPause();*/
					var text = "Provide a number to be insert.";
						...
						flip("#tooltipFront", frontVal, function() {
							...
							typing($(".introjs-tooltiptext ul li:last-child div").last(), text, function() {
								...
								if (frontVal == -1) {
									...
									console.log(introjs._introItems);
									console.log(introjs._introItems.length);
	...
	if (flag) {
		...
		//introjs.goToStep(introjs._currentStep + 1);
	}
}