...
Graph.prototype.edge = function() {
	...
	if (edgesMap[fromEdge + "-" + toEdge] == undefined) {
		if (edgesMap[toEdge + "-" + fromEdge] != undefined) {
			...
			/*if ((fromEdge == 0 && (toEdge == 3 || toEdge == 4)) || (fromEdge == 3 && )) {
				
			}*/
			
			/*this.cmd("Connect", this.vertices[fromEdge], this.vertices[toEdge]);*/
			/*edgesMap[fromEdge + "-" + toEdge] = {"edge" : this.nextIndex};
			this.cmd("DrawLine", this.nextIndex++, VERTICES_FIXID_X_POS[fromEdge] - 10, VERTICES_FIXID_Y_POS[fromEdge] + 18,
					VERTICES_FIXID_X_POS[toEdge] + 15, VERTICES_FIXID_Y_POS[toEdge] - 20, 1);*/
		}
