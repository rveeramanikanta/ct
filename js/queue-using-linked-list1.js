...
var queueUsingLinkedListReady = function() {
	$(".line").hide();
					...
					switch(animateStep) {
						...
						case "dequeueMethod":
							...
							$("#methodCode").append('<div id="dequeueMethod">'
									...
									+ '<span id="ifElseCondition">&emsp;&emsp;&emsp;&emsp;<span id="line6">if (<span id="flipFront">' 
											+ 'front</span> == <span id="flipRear">rear</span>) {</span></br>'
									+ '&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<span id="line7">front = rear = NULL;</span></br>'
									+ '&emsp;&emsp;&emsp;&emsp;<span id="line8">} else {</span></br>'
									+ '&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<span id="line9">front = front->next;</span></br>'
									+ '&emsp;&emsp;&emsp;&emsp;<span>}</span></span></br>'
